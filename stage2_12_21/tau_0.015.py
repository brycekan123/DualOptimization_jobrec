...
TAU = 0.015  # Target qualification rate (~1%, moderate challenge based on qual_head predictions)
...
# Output directory
OUTPUT_DIR = os.path.join(SCRIPT_DIR, f"stage2_output/run_tau_0.015")
